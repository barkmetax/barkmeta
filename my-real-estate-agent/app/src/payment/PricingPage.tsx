...
export const paymentPlanCards: Record<PaymentPlanId, PaymentPlanCard> = {
  ...
  [PaymentPlanId.Pro]: {
    ...
    features: [
      "5 target markets",
      "Hourly listing reports",
      "AI lead scoring",
      "Automated outreach (email + SMS)",
    ...
    <div className="py-10 lg:mt-10">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <p className="text-muted-foreground mx-auto mt-6 max-w-2xl text-center text-lg leading-8">
          ...
          agents that work around the clock to find deals and grow your pipeline.
        </p>
        {errorMessage && (
            ...
            >
              ...
              <CardFooter>
                {isUserSubscribed ? (
                  ...
                  >
                    {!!user ? "Start Free Trial" : "Log in to start"}
                  </Button>
                )}
              </CardFooter>
            </Card>
